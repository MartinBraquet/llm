...
ddp = int(os.environ.get('RANK', -1)) != -1  # is this a distributed data parallel run (multiple GPU nodes)?
ddp_local_rank = None
if ddp:
...
iter_save_init_ckpt = 0 if init_from.startswith('gpt2') else min(eval_interval, 10)
...
if init_from == 'scratch':
    ...
    iter_num = model_loader.checkpoint['iter_num']
